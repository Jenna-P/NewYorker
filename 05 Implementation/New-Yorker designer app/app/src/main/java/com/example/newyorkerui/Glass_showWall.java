...
public class Glass_showWall extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String totalFrame_g_str = bundle.getString("totalFrame_gt");
        String totalGlass_g_str = bundle.getString("totalGlass_gt");
        String totalPrice_g_str = bundle.getString("totalPrice_gt");
        String chosenGlass_g_str = bundle.getString("chosenGlass_gt");

        this.totalFrame_g.setText(totalFrame_g_str);
        this.totalGlass_g.setText(totalGlass_g_str);
        this.totalPrice_g.setText(totalPrice_g_str);
        this.chosenGlass_g.setText(chosenGlass_g_str);

        //should find better way to get image(already set) from showWall class
        if(totalFrame_g_str.equals("2") && totalGlass_g_str.equals("6")) {
            wallDesign_g.setImageResource(R.drawable.a23);
        } else if (totalFrame_g_str.equals("2") && totalGlass_g_str.equals("8")) {
        ...
        adjust_g.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("totalPrice_g", totalPrice_g_str);
                intent.putExtra("class", "g_showWall");
                startActivity(intent);
